...
class MyFirebaseMessaging:FirebaseMessagingService() {
    ...
    private fun sendNotification(mRemoteMessage: RemoteMessage) {
        ...
        val defaultSouund = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION)
    ...
    private fun sendOreoNotification(mRemoteMessage: RemoteMessage) {
        ...
        val builder: Notification.Builder = oreoNotifications.getOreoNotification(title, body, pendingIntent,defaultSouund, icon)
